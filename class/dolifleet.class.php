...
//        $picto='dolifleet@dolifleet';
    ...
    public static function LibStatut($status, $mode)
    {
        ...
        if ($status==self::STATUS_CANCELED) { $statusType='status9'; $statusLabel=$langs->trans('doliFleetStatusCancel'); $statusLabelShort=$langs->trans('doliFleetStatusShortCancel'); }
        elseif ($status==self::STATUS_DRAFT) { $statusType='status0'; $statusLabel=$langs->trans('doliFleetStatusDraft'); $statusLabelShort=$langs->trans('doliFleetStatusShortDraft'); }
        elseif ($status==self::STATUS_VALIDATED) { $statusType='status1'; $statusLabel=$langs->trans('doliFleetStatusValidated'); $statusLabelShort=$langs->trans('doliFleetStatusShortValidate'); }
        elseif ($status==self::STATUS_REFUSED) { $statusType='status5'; $statusLabel=$langs->trans('doliFleetStatusRefused'); $statusLabelShort=$langs->trans('doliFleetStatusShortRefused'); }
        elseif ($status==self::STATUS_ACCEPTED) { $statusType='status6'; $statusLabel=$langs->trans('doliFleetStatusAccepted'); $statusLabelShort=$langs->trans('doliFleetStatusShortAccepted'); }
