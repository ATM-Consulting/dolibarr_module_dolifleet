...
class dolifleetVehiculeOperation extends SeedObject
{
	...
	public function create(User &$user)
	{
		...
		if (empty($this->id)) $this->rank = (int) $this->getMaxRank() + 1;
	...
	{
		$sql = "SELECT MAX(rank) as maxrank FROM ".MAIN_DB_PREFIX.$this->table_element." WHERE fk_vehicule = ".$this->fk_vehicule;
